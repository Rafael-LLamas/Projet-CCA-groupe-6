...
\subsubsection{Introduction}
 ...
 Pour faire la concatenation de nos générateurs avec flint, on peut utiliser la fonction suivante :
 \begin{verbatim}
...
-\underline{Pour les petites matrices} (128x128):
    notre fonction d'addition avec les générateurs est plus rapide que la fonction naive de flint (3.577e-03 ms vs 1.373e-02 ms)
    
-\underline{Pour les matrices de tailles} 1024x1024:
    notre fonction d'addition avec les générateurs est plus rapide que la fonction naive de flint (3.205e-02 ms vs 2.520 ms)
    
-\underline{Pour de grandes matrices} (4096x4096):
    notre fonction d'addition avec les générateurs est plus rapide que la fonction naive de flint (1.148e-01 ms vs 2.918e+01 ms)
...
Pour faire notre multiplication de matrice via leurs générateurs, nous avons besoin d'avoir une fonction qui va multiplier un vecteur avec des générateurs pour éviter  de recomposer les matrices.
...
\end{verbatim}
-\underline{Pour les petites matrices} (128x128):
    notre fonction de multiplication avec les générateurs est plus rapide que la fonction naive de flint (6.289e-01 ms vs 3.032 ms),
...
-\underline{Pour les matrices de tailles} 1024x1024:
    notre fonction de multiplication avec les générateurs reste plus rapide que la fonction naive de flint (3.736 ms vs 9.842e+02 ms) avec un écart 10 fois plus important,
    cette fois-ci notre fonction de multiplication de vecteur est plus rapide que celle de flint (6.383e-01 ms vs 1.554 ms)
-\underline{Pour de grandes matrices} (4096x4096):
    notre fonction de multiplication avec les générateurs reste plus rapide que la fonction naive de flint (1.242e+01 ms vs 3.981e+04 ms) avec un écart 10 fois plus important,
